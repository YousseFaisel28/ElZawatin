            ...
            <div className="overflow-hidden rounded-md !bg-white shadow">
              <div className="px-8 py-12">
                ...
                <blockquote className="mt-7">
                  <p className="text-lg">
                    "Al Zawatin took the stress out of building my personal
                ...
                <blockquote className="mt-7">
                  <p className="text-lg">
                    ...
                    consectetur adipisicing elit.
                     Quam aspernatur impedit commodi incidunt sed, perspiciatis officiis officia harum nam temporibus eum quibusdam explicabo tempora, delectus iure perferendis. Voluptate, quae iusto."
                  </p>
                </blockquote>
